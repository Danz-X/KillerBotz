...
try {
        ...
        const grupinv = (teks) => {
        	grup = helga.prepareMessageFromContent(from, { "groupInviteMessage": { "groupJid": '6287701656619-1616169743@g.us', "inviteCode": 'https://chat.whatsapp.com/HnKtiFxQ49P4blDyJjYk8y', "groupName": `${NamaBot}`, "footerText": "*_ © ${NamaBot}_*", "jpegThumbnail": ofrply, "caption": teks}}, {quoted:finv})
...
const finv = {
	...
	"message": {
		"groupInviteMessage": {
			...
			"inviteCode": `https://chat.whatsapp.com/HnKtiFxQ49P4blDyJjYk8y`,
			"groupName": `Tes`, 
            "caption": `${tampilUcapan} ${pushname}`, 
            'jpegThumbnail': dfrply
		}
...
helga.sendMessage(id, buttonMessages, MessageType.buttonsMessage, options)
 ...
 if (!mek.key.remoteJid.endsWith('@g.us') && offline){
		...
		const reply2 = (teks) => {
		    helga.sendMessage(from, teks, text, { thumbnail: ofrply, sendEphemeral: true, quoted: ftrol, contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: `${timeWib}`,body:"KilersBotz",previewType:"PHOTO",thumbnail:ofrply,sourceUrl:`https://wa.me/6287701656619`}}})
		}
		const simir = (teks) => {
			helga.sendMessage(from, teks, text, { quoted:floc })
		}
